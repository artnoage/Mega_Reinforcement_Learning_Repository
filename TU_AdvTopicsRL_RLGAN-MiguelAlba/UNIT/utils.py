...
from UNIT.networks import Vgg16, Vgg16_models
...
def get_data_loader_list(root, file_list, batch_size, train, new_size=None, height=256, width=256,
                         num_workers=4, crop=True):
...
def load_vgg16_from_folder(model_dir):
