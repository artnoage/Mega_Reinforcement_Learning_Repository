...
def get_args():
    ...
    parser.add_argument('--env-name', default='RoadFighterLvl1',
    ...
    parser.add_argument('--gan-dir', default='./roadfighter-lvl2',
    ...
    parser.add_argument('--gan-imitation-file', type=str, default='',
                        help='the gan file used for the imitation learning algorithm')
    ...
    parser.add_argument('--num-collected-imgs', type=int, default=1e5,
